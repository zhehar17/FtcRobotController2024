...
public class FollowerConstants {
    ...
    private static double xMovement = 59.04322;
    private static double yMovement = 46.1969;
    ...
    public static double mass = 12.88202;
    ...
    public static double forwardZeroPowerAcceleration = -50.25656;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -85.89068;
