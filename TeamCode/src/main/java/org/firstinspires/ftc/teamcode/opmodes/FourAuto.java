...
//                                new Point(54.729, 16.598, Point.CARTESIAN)
//                        )
//                )
//                .setLinearHeadingInterpolation(Math.toRadians(200), Math.toRadians(190))
//                .addPath(
//                        // Line 4
//                        new BezierLine(
//                                new Point(54.729, 16.598, Point.CARTESIAN),
//                                new Point(22.430, 10.766, Point.CARTESIAN)
//                        )
//                )
...
//                        new BezierLine(
//                                new Point(22.430, 10.766, Point.CARTESIAN),
//                                new Point(20.000, 20.000, Point.CARTESIAN)
//                        )
//                )
...
//                if (follower.getPose().getX() < 10.5 || !follower.isBusy()) {//follower.getPose().getX() < 10.5 || !follower.isBusy()
//                    claw.closeClaw();
//                    if (!timerStarted) {
//                        timerStarted = true;
//                        timer = pathTimer.getElapsedTimeSeconds();
